...
exports.addstudent = async (req, res) => {
    if (req == undefined || req.body == undefined || req.body.student_name == undefined
         || req.body.email == undefined || req.body.password == undefined || req.body.phone_no == undefined || req.body.roll_no == undefined || req.body.qualification == undefined || req.body.city == undefined || req.body.gender == undefined) 
         {
        res.json({
