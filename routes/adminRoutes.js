...
const paperController = require('../apis/admin/oldpapers/oldpaperController')
...
const videoController =require('../apis/admin/Videos/videoController')
...
//oldpapers
router.post('/addpaper', upload.single('upload_file'), paperController.addpaper)
router.post('/viewpaper', paperController.showpaper)
